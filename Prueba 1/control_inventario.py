...
while True:
    ...
    if select == 1:
        ...
        if otro_producto == "1":
            ...
            precio2 = float(input("Escribe el precio del producto: "))
            cantidad2 = int(input("Escriba la cantidad disponible: "))
            if cantidad2 == 0 or precio2 == 0:
                print("Escriba un valor mayor a 0 en precio y cantidad")
            else:
    ...
    if select == 2: 
        ...
        if  producto == "" and precio == 0 or precio2 == 0 and producto2 == "":
                print("No hay productos registrados, por favor registre un producto para usar esta función")
        else:
            print("Productos registrados: ", producto, "y", producto2)
            producto_calcular = input("Escriba el nombre del producto a calcular (solo uno): ")
    ...
    if select == 3:
        ...
        if  producto == "" or precio == 0 or cantidad == 0:
                print("No hay productos registrados, por favor registre un producto para usar esta función")
        else:
